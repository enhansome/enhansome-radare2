...
* [Radare2 and Frida better together](https://github.com/nowsecure/r2frida) ⭐ 1,439 | 🐛 46 | 🌐 TypeScript | 📅 2026-09-18
* [Deep ghidra decompiler integration for radare2](https://github.com/radareorg/r2ghidra-dec) ⭐ 981 | 🐛 61 | 🌐 C++ | 📅 2026-08-17
...
* [Python-r2pipe script that draws ascii and graphviz graphs of library dependencies](https://github.com/radare/radare2-r2pipe/blob/master/python/examples/libgraph.py) ⭐ 466 | 🐛 19 | 🌐 JavaScript | 📅 2026-09-14
